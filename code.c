...
void loop() {
  ...
  if (readsuccess) {
    ...
    String UIDresultSend, postData, terminalID;
    UIDresultSend = StrUID;

    //Post Data
    terminalID = "a"
    postData = "UIDresult=" + terminalID + UIDresultSend;

    http.begin(client,"http://192.168.18.35/NodeMCU-and-RFID-RC522-IoT-Projects/getUID.php");  //Specify request destination
